...
var R=1800000000;
var volume=400*400;
var gravity={direction:270, strength:0.1};
var friction=0;
var pressure=0;
var pressures=50;
var collisions=[];
...
//make ideal pressure
// make bonds? haha
//      negative and positive points on a molecule, every charged point is attracted or repelled to every other charged point, should cancel out. If pull is stronger than bond strength, break. If bond stronger than electrostatic force, bond.
...
var draw = function() {
    ...
    stroke(255, 0, 0);
    strokeWeight(1);
    line(200,200,200+cos(gravity.direction)*500*gravity.strength,200-sin(gravity.direction)*500*gravity.strength);
    noStroke();
    fill(17, 255, 0);
    text("KE: "+KE(),5,13);
    text("E: "+(KE()+PE()),5,40);
